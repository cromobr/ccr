...
// SHOW COMMENT FORM
	...
	<tr>
		<td>
			'. $mg2->lang['comment'] .'<br />
			<textarea cols="65" rows="3" name="body" id="body" class="comment-textfield">'. $workon[3] .'</textarea>
		</td>
	</tr>
	<tr>
		<td>
			'. $mg2->lang['name'] .'<br />
			<input type="text" size="80" maxlength="90" name="name" id="name" value="'. $workon[1] .'" class="comment-textfield" />
		</td>
	</tr>
	<tr>
		<td>
			'. $mg2->lang['email'] .'<br />
			<input type="text" size="80" maxlength="90" name="email" id="email" value="'. $workon[2] .'" class="comment-textfield" />
		</td>
	</tr>
	';
	...
	if ($mg2->commentsets & 256) {
		echo '
			<tr>
				<td>'.
					$mg2->lang['captcha'] .'<br />
					<input type="text" name="captcha" id="captcha" value="" class="comment-textfield" style="width:'.($captcha_width-8).'px" />
				</td>
			</tr>
			<tr>
				<td>'.
